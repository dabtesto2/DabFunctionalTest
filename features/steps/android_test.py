...
def step_impl(context, device_profile, apn_name, seconds):
    ...
    allure.attach.file(android_device_obj.get_android_device_screen_shot(), name="apn_" + apn_name,
...
def step_impl(context, status):
    ...
    allure.attach.file()
    allure.attach.file(android_device_obj.get_android_device_screen_shot(), name="Device_ip_status",
                       attachment_type=AttachmentType.PNG)
...
def step_impl(context, device_profile, network_type):
    ...
    allure.attach.file(android_device_obj.get_android_device_screen_shot(), name="Check_Data_connection_status",
                       attachment_type=AttachmentType.PNG)
