...
def step_impl(context, link):
    ...
    scroll_h = (int(height['height'])/4)
    scroll_h1 = int(scroll_h * 1.5)
    scroll_h2 = int(scroll_h * 2)
    scroll_h3 = int(scroll_h * 2.5)
    scroll_h4 = int(scroll_h * 3)
    scroll_h5 = int(scroll_h * 3.5)
    scroll_h6 = int(scroll_h * 4)
    print(scroll_h5)