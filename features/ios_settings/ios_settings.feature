  ...
  Scenario Outline: Configure iOS settings
    ...
    Examples:
      ...
      | dab.test.apn1 | dabfull@mobile.dabfull.ref   | password | 5         | iphone8 | https://www.bbc.co.uk |
      | dab.test.apn1 | dabfull@ibrowse.dabfull.ref  | password | 5         | iphone8 | https://www.bbc.co.uk |
      | dab.test.apn1 | dabfull@m-bb.dabfull.ref     | password | 5         | iphone8 | https://www.bbc.co.uk |
      | dab.test.apn1 | dabfull@isetup.dabfull.ref   | password | 5         | iphone8 | https://www.bbc.co.uk |
      | dab.test.apn1 | dabfull@modem.dabfull.ref    | password | 5         | iphone8 | https://www.bbc.co.uk |
      | dab.test.apn1 | dabfull@mvne1.dabfull.ref    | password | 5         | iphone8 | https://www.bbc.co.uk |
      | dab.test.apn1 | dabfull@tesco.dabfull.ref    | password | 5         | iphone8 | https://www.bbc.co.uk |
