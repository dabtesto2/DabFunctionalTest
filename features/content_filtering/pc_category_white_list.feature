  ...
  Scenario Outline: With Android Device profile setup the context for <apn> with device profile <device_profile>
    ...
    Examples:
      ...
      | idata-full-epg1 | http://safekids.com/      | safekids | 2        | 5              | PC             |
      | tesco-full-epg1 | http://safekids.com/      | safekids | 2        | 5              | PC             |
      ...
      | tesco-full-epg1 | http://www.roalddahl.com/ | roal     | 2        | 5              | PC             |
  ...
  Scenario Outline: With Android Device profile setup the context for <apn> with device profile <device_profile>
    ...
    Examples:
      | apn             | url                       | title    | no_links | data_conn_wait | device_profile |
      | idata-func-epg1 | http://safekids.com/      | safekids | 2        | 5              | PC             |
      | tesco-func-epg1 | http://safekids.com/      | safekids | 2        | 5              | PC             |
      ...
      | tesco-func-epg1 | http://www.roalddahl.com/ | roal     | 2        | 5              | PC             |
  @cf_nds_cat_serv
  ...
  Scenario Outline: With Android Device profile setup the context for <apn> with device profile <device_profile>
    ...
    Examples:
      | apn             | url                       | title    | no_links | data_conn_wait | device_profile |
      | idata-serv-epg1 | http://safekids.com/      | safekids | 2        | 5              | PC             |
      | tesco-serv-epg1 | http://safekids.com/      | safekids | 2        | 5              | PC             |
      ...
      | tesco-serv-epg1 | http://www.roalddahl.com/ | roal     | 2        | 5              | PC             |