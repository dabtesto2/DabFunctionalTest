  Feature: Verify if Device is blocked when trying to browse item from o2 alcohol list for http and https

  @cf_nds_cat_o2_alcohol_full

  Scenario Outline: Block when user browse item from o2 alcohol  list using <apn> with device profile <device_profile>
